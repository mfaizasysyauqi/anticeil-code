				...
				<div className="mb-5" id="terminal-settings-section">
					{isVsCodePlatform && (
						<div className="mb-4">
							...
							<p className="text-xs text-[var(--vscode-descriptionForeground)] mt-1">
								Choose whether Anticeil Code runs commands in the VS Code terminal or a background process.
							</p>
						</div>
					)}
						...
						<>
							<div className="mb-4">
								...
								<p className="text-xs text-(--vscode-descriptionForeground)">
									Set how long Anticeil Code waits for shell integration to activate before executing commands. Increase
							...
							<div className="mb-4">
								...
								<p className="text-xs text-(--vscode-descriptionForeground)">
									When enabled, Anticeil Code will reuse existing terminal windows that aren't in the current working
					...
					<div className="mb-4">
						...
						<p className="text-xs text-(--vscode-descriptionForeground) mt-1">
							Select the default terminal Anticeil Code will use. 'Default' uses your VSCode global setting.
						</p>
					</div>
